...
* Installing the ESP32 Board in Arduino IDE (Windows, Mac OS X, Linux) [randomnerdtutorials.com](https://randomnerdtutorials.com/installing-the-esp32-board-in-arduino-ide-windows-instructions/).
